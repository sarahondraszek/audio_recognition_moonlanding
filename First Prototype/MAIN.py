...
import os
import time
from input_key_ctrl_micr import simulate_key_press, release_key, record_order
...
def choose_player():
    ...
    rocket_01 = pygame.image.load(resource_path("data/naumannnofire.png"))
    rocket_02 = pygame.image.load(resource_path("data/studiforcenofire.png"))
    rocket_03 = pygame.image.load(resource_path("data/kuglernofire.png"))
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                ...
                if event.key == K_ESCAPE:
                    ...
                    exit = True
                if event.key == K_1:
                    path = "data/naumannnofire.png"
                    pathfire = "data/naumannfire.png"
                    start = False
                if event.key == K_2:
                    path = "data/studiforcenofire.png"
                    pathfire = "data/studiforcefire.png"
                    start = False
                if event.key == K_3:
                    path = "data/kuglernofire.png"
                    pathfire = "data/kuglerfire.png"
                    start = False
            if event.type == QUIT:
                start = False
                exit = True
